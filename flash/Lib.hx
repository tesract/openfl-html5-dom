...
class Lib {
	...
	public static function __appendSurface (surface:Element, before:Element = null, after:Element = null):Void {
	...
	public static inline function __isOnStage (surface:Element):Bool {
	...
	public static function __removeSurface (surface:Element):Dynamic {
	...
	public static function __setSurfaceTransform (surface:Element, matrix:Matrix):Void {
	...
	public static function __swapSurface (surface1:Element, surface2:Element):Void {
	...
	public inline static function __setSurfaceId (surface:Element, name:String):Void {
	...
	public inline static function __setSurfaceVisible (surface:Element, visible:Bool):Void {
